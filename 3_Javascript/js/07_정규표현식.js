...
document.getElementById("check1").addEventListener("click", function(){
    ...
    const str1 = "저희는 지금 javascript 를 공부하고 있습니다.";
...
document.getElementById("check2").addEventListener("click", function(){
    ...
    div1.innerHTML += "/^group/ , Agroup : " + regEx2.test("Agroup") + "<hr>";
    ...
    div1.innerHTML += "/^[abcd]/ , banana : " + regEx3.test("banana") + "<hr>";
    ...
    // ^[ABCD]-team$
    // -> A-team / B-team / C-team / D-team이 맞으면 true / 아님 false
