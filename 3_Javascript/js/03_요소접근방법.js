...
function fnTest1(){
    ...
    // id가 "div1"인 요소를 얻어와 상수형 변수에 div1에 저장
...
function fnTest3(){
    ...
    for(let i=0; i<arr.length; i++){
        ...
        arr[i].style.backgroundColor = "rgb(200," + num + ",50)";
...
function fnTest5(){
    ...
    let str = ""; // 체크된 checkbox의 값을 누적할 변수 선언
    ...
    if(str != ""){ // 체크가 된 경우
        ...
        result5.innerHTML += "<br><br>취미가 " + count + "개 선택되었습니다.";
    } else{
